...
execute if score @s wasd.bleed_timer matches 60.. run particle minecraft:block{block_state:{Name:"minecraft:redstone_block"}} ~ ~1 ~ 0.2 0.3 0.2 1 25
execute if score @s wasd.bleed_timer matches 60.. run particle minecraft:falling_dust{block_state:{Name:"minecraft:red_wool"}} ~ ~ ~ 0.4 0 0.4 0 30
execute if score @s wasd.bleed_timer matches 60.. run particle minecraft:dust{color:[1.0, 0.0, 0.0], scale:1.0} ~ ~1 ~ 0.2 0.5 0.2 0 10
