...
particle dust_color_transition{from_color:[0.0, 1.0, 0.051], scale:2.0, to_color:[0.0, 0.596, 0.031]} ^-4 ^0.1 ^
execute as @s[scores={wasd.temp2=10..}] run function wasd.magic:zzz/89
execute as @s[scores={wasd.temp=10}] run function wasd.magic:zzz/90
execute as @s[scores={wasd.temp=20}] run function wasd.magic:zzz/91
execute as @s[scores={wasd.temp=30}] run function wasd.magic:zzz/92
execute as @s[scores={wasd.temp=40}] run function wasd.magic:zzz/93
