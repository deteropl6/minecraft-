...
execute unless score exploding_anvil w.tnt_settings matches 1 as @e[type=#wasd.tags:mobs_player,distance=..1.2] run damage @s 8 minecraft:falling_stalactite
