...
particle falling_dust{block_state:{Name:"minecraft:dripstone_block"}} ~ ~0.1 ~ 0.2 0 0.2 1 2 normal
...
execute as @s[scores={wasd.temp=7..}] run function wasd.magic:zzz/91