...
execute positioned ~ ~1.5 ~ as @e[type=#wasd.tags:mobs_player,distance=..1.5] run damage @s 6 minecraft:player_attack by @n[tag=wasd.water]
execute positioned ~ ~ ~ as @e[type=#wasd.tags:mobs_player,distance=..1.5] run damage @s 6 minecraft:player_attack by @n[tag=wasd.water]
execute positioned ~ ~-1.5 ~ as @e[type=#wasd.tags:mobs_player,distance=..1.5] run damage @s 6 minecraft:player_attack by @n[tag=wasd.water]
kill @s