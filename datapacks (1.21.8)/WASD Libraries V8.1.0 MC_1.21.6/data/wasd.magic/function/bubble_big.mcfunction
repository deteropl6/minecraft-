...
execute as @s[scores={wasd.timer=160..}] run function wasd.magic:zzz/100
...
execute positioned ~ ~ ~ as @a[tag=wasd.in_bubble,distance=..2] run effect give @s levitation 1 0 true
tp @s ~ ~0.07 ~