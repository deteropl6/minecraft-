...
execute as @e[type=#wasd.tags:dead,distance=..5] unless predicate wasd.lib:on_fire run function wasd.magic:zzz/155
execute as @s[scores={wasd.timer=1200..}] run function wasd.magic:zzz/156