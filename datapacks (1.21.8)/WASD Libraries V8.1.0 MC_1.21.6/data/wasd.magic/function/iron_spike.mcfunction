...
execute as @s[scores={wasd.timer=1}] as @e[tag=wasd.iron_spike,tag=!wasd.given_rotation] at @s run function wasd.magic:zzz/82
...
execute as @s[scores={wasd.timer=85}] run function wasd.magic:zzz/84
execute as @s[scores={wasd.timer=101..}] run function wasd.magic:zzz/85
execute as @s[tag=wasd.remove] run function wasd.magic:zzz/90