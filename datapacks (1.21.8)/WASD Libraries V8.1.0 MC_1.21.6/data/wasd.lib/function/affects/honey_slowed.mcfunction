...
particle block{block_state:{Name:"minecraft:honey_block"}} ~ ~1 ~ 0 0.2 0 0 5
particle minecraft:falling_dust{block_state:{Name:"minecraft:honey_block"}} ~ ~1 ~ 0.2 0.3 0.2 0 2
