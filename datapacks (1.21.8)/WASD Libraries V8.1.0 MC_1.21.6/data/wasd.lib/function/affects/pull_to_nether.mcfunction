...
execute align y run particle minecraft:falling_dust{block_state:{Name:"minecraft:purple_concrete"}} ~ ~1 ~ 0.2 0 0.2 0 15
execute align y run particle minecraft:falling_dust{block_state:{Name:"minecraft:black_concrete"}} ~ ~1 ~ 0.3 0 0.3 0 20
execute align y run particle minecraft:falling_dust{block_state:{Name:"minecraft:brown_terracotta"}} ~ ~1 ~ 0.5 0 0.5 0 15
