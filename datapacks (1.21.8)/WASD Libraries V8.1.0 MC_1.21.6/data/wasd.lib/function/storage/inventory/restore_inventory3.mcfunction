execute if dimension minecraft:overworld run summon area_effect_cloud ~ 319 ~ {Tags:["wasd.box_location"]}
execute unless dimension minecraft:overworld run summon area_effect_cloud ~ 255 ~ {Tags:["wasd.box_location"]}
...
execute at @e[tag=wasd.box_location] run loot replace entity @s hotbar.0 27 mine ~ ~ ~ yellow_shulker_box[custom_data={drop_contents:1b}]
...
execute if dimension minecraft:overworld run summon area_effect_cloud ~ 318 ~ {Tags:["wasd.box_location2"]}
execute unless dimension minecraft:overworld run summon area_effect_cloud ~ 254 ~ {Tags:["wasd.box_location2"]}
...
execute if dimension minecraft:overworld run summon area_effect_cloud ~ 317 ~ {Tags:["wasd.box_location3"]}
execute unless dimension minecraft:overworld run summon area_effect_cloud ~ 253 ~ {Tags:["wasd.box_location3"]}
...
execute if dimension minecraft:overworld run summon area_effect_cloud ~ 316 ~ {Tags:["wasd.box_location4"]}
execute unless dimension minecraft:overworld run summon area_effect_cloud ~ 252 ~ {Tags:["wasd.box_location4"]}
...
execute at @e[tag=wasd.box_location2] run loot replace entity @s inventory.18 14 mine ~ ~ ~ yellow_shulker_box[custom_data={drop_contents:1b}]
...
execute at @e[tag=wasd.box_location3] run loot replace entity @s armor.feet 4 mine ~ ~ ~ yellow_shulker_box[custom_data={drop_contents:1b}]
...
execute at @e[tag=wasd.box_location4] run loot replace entity @s weapon.offhand 1 mine ~ ~ ~ yellow_shulker_box[custom_data={drop_contents:1b}]
