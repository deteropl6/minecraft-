...
execute as @s[tag=wasd.block_location] run function wasd.lib:util/block_location
...
execute as @s[tag=wasd.spreading_withered_block] run function wasd.abilities:affects/spreading_withered_block
execute as @s[tag=wasd.dragoned_block] run function wasd.abilities:affects/dragoned_block
execute as @s[tag=wasd.painted] run function wasd.abilities:affects/painted